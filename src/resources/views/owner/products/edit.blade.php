                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="post" action="{{ route('owner.products.update', ['product' => $product->id]) }}">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <textarea rows="10" id="information" name="information" required
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div>
                                        <input type="radio" name="type" class="mr-2" checked value="1">追加
                                    </div>
                                    <div>
                                        <input type="radio" name="type" class="mr-2" value="2">削減
                                    </div>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="category" id="category"
                                        class="leading-7 text-sm text-gray-600">カテゴリ</label>
                        ...
                        <div class="p-2 w-1/2 mx-auto">
                            <div class="relative flex justify-around">
                                <div>
                                    <input type="radio" name="is_selling" class="mr-2"
                                        @if ($product->is_selling === 1) { checked } @endif
                                        value={{ \Constant::PRODUCT_LIST['add'] }}>販売中
                                </div>
                                <div>
                                    <input type="radio" name="is_selling" class="mr-2"
                                        @if ($product->is_selling === 0) { checked } @endif
                                        value={{ \Constant::PRODUCT_LIST['reduce'] }}>停止中
                                </div>
                            </div>
                        </div>
                    ...
                    <form method="post" id="delete_{{ $product->id }}"
